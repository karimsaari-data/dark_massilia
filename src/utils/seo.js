...
export const SEO_PAGES = {
  ...
  '/court-metrage-green-got-mediterranee': {
    ...
    image: `${BASE_URL}/images/green-got-karim-saari-barque-vieux-port-marseille.jpg`,
    imageAlt: 'Karim Saari à bord d\'une barque dans le Vieux-Port de Marseille — court-métrage de la Fondation Green-Got',
    schema: {
      '@context': 'https://schema.org',
      '@graph': [
