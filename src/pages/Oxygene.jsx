...
const FEATURED_PHOTOS = [
  ...
  'cms.karimsaari.com/wp-content/uploads/2026/07/147-006A3932-1024x683.jpg',    // landscape — Christine Leuthy (CITEO) et l'équipe devant le mur des partenaires
].map(toCdn);
...
const GALLERY_PHOTOS = [
  ...
  'cms.karimsaari.com/wp-content/uploads/2026/07/85-0I4A5630-1-1-1024x683.jpg', // descendue depuis le pavé CITEO
].map(toCdn);
          ...
          <motion.div variants={FADE_IN_UP} className="glass-strong rounded-3xl overflow-hidden flex flex-col lg:flex-row">
            ...
            <div className="lg:w-[42%] flex-shrink-0 min-h-[300px] lg:min-h-0 overflow-hidden">
              <img
                ...
                alt="Christine Leuthy (CITEO) et l'équipe Team Oxygen devant le mur des partenaires, soirée de projection du documentaire Oxygène à la Grotte Cosquer Méditerranée, Marseille"
                className="w-full h-full object-cover object-center"
                loading="lazy"
                decoding="async"
                width="1024"
