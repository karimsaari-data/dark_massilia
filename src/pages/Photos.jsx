        ...
        <Tag key={image.uid} className="break-inside-avoid mb-4" {...motionProps}>
          ...
          >
            <img
              ...
              className="w-full h-auto object-cover brightness-95 saturate-[0.85] group-hover:brightness-100 group-hover:saturate-[1.05] group-hover:scale-105 transition-[transform,filter] duration-500 ease-out"
              loading={(index + 1) < 4 ? 'eager' : 'lazy'}
              decoding="async"
            />
            {caption && (
              <div
                className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/0 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-3 pointer-events-none"
                aria-hidden="true"
              >
                <span className="text-white text-[11px] font-medium leading-snug line-clamp-2 translate-y-1.5 group-hover:translate-y-0 transition-transform duration-300">
                  {caption}
                </span>
              </div>
            )}
        ...
        >
          <motion.div variants={FADE_IN_UP} className="glass-strong rounded-3xl p-8 md:p-12">
            ...
            <div className="space-y-5 text-text-secondary leading-[1.85] text-sm md:text-base">
              ...
              <p>
                Tout a commencé avec un <strong className="text-white font-medium">boîtier argentique</strong> et des étés en haute montagne. Adolescent, je passais chaque été à rôder autour de <strong className="text-white font-medium">Chamonix</strong>, sac au dos, à arpenter les glaciers et les crêtes du massif du Mont-Blanc. C'est là que j'ai rencontré un guide de haute montagne qui, entre deux cordées, sortait son appareil pour capturer la <strong className="text-white font-medium">lumière rasante sur les séracs</strong>. Il m'a appris l'essentiel : ne pas chercher à dominer le paysage, mais à <strong className="text-white font-medium">l'écouter</strong>.
              </p>
              <p>
                La contrainte de la pellicule — <strong className="text-white font-medium">36 poses, pas une de plus</strong> — m'a enseigné la patience et l'intention. Chaque déclenchement était une décision, pas une habitude. Ma façon de travailler est restée la même : <strong className="text-white font-medium">peu de clichés, beaucoup d'observation</strong>. Attendre la lumière, pas la forcer.
              </p>
              <p>
                Natif de la <strong className="text-white font-medium">côte basque</strong>, mes premières images ont naturellement été celles de l'océan. Les rouleaux de <strong className="text-white font-medium">Biarritz</strong> sous les ciels gris d'automne, les collines vertes de l'arrière-pays, les villages perchés sur les contreforts des <strong className="text-white font-medium">Pyrénées</strong>. J'ai appris à lire la lumière atlantique — douce, changeante, parfois brutale.
              </p>
              <p>
                Puis en 2001, je suis arrivé à <strong className="text-white font-medium">Marseille</strong>. Et tout a basculé. En quelques heures de route, on passe du <strong className="text-white font-medium">bleu turquoise des Calanques</strong> aux ocres du Luberon, des marais sauvages de Camargue aux <strong className="text-white font-medium">plateaux de lavande de Valensole</strong>, des criques du Var aux reliefs des Alpilles. Une richesse photographique qui ne m'a plus jamais lâché.
              </p>
              <p>
                Mais l'appel du large ne s'est jamais tu. Le <strong className="text-white font-medium">Maroc</strong> d'abord — les ruelles bleues de Chefchaouen, les medinas de Marrakech. <strong className="text-white font-medium">Madère</strong> ensuite, falaises verticales, forêts laurifères, levadas entre deux horizons. Et toujours <strong className="text-white font-medium">l'Atlantique</strong> de mon adolescence — les dunes du Pilat, les vagues de Biarritz, les plages de Capbreton.
              </p>
              <p>
                Depuis dix ans, j'habite <strong className="text-white font-medium">chemin de Morgiou</strong>, à l'entrée du <strong className="text-white font-medium">Parc National des Calanques</strong>. Cette proximité a progressivement transformé mon regard. Ce n'était plus seulement de la <strong className="text-white font-medium">photographie de paysages</strong> : c'était de la <strong className="text-white font-medium">documentation, du témoignage</strong>. C'est en plongeant en apnée que j'ai découvert l'ampleur de la <strong className="text-white font-medium">pollution plastique sur les fonds marins</strong>. La photographie m'avait appris à voir. L'apnée m'a appris ce qu'il y avait à perdre.
              </p>
